...
const Header = () => {
  ...
  return (
    <div className="min-h-95screen relative w-full gradiant-green-background mb-8  p-8 md:pr-32 md:pl-32  2xl:pr-96 2xl:pl-96 flex flex-col items-center">
      {/* Header */}
      <header className="flex flex-col h-5/6 mb-12">
        {/* Nav Menu */}
        ...
        <div className="flex flex-col md:w-5/6 2xl:w-4/6  z-20">
          ...
          <a className="bg-white hover:bg-main-green text-black w-fit h-fit p-5 pr-6 pl-6 text-xs font-bold rounded-md z-10 transition-all">
            GET IN TOUCH!
          </a>
        </div>
